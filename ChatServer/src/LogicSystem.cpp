...
void LogicSystem::RegisterCallBacks() {
	_fun_callbacks.emplace(MSG_CHAT_LOGIN,std::bind(&LogicSystem::LoginHandler, this,
		std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

	_fun_callbacks.emplace(ID_SEARCH_USER_REQ,std::bind(&LogicSystem::SearchInfo, this,
	std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

	_fun_callbacks.emplace(ID_ADD_FRIEND_REQ,std::bind(&LogicSystem::AddFriendApply, this,
	std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
	_fun_callbacks.emplace(ID_AUTH_FRIEND_REQ,std::bind(&LogicSystem::AuthFriendApply, this,
	std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
	_fun_callbacks.emplace(ID_TEXT_CHAT_MSG_REQ,std::bind(&LogicSystem::DealChatTextMsg, this,
	std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
	_fun_callbacks.emplace(ID_HEART_BEAT_REQ,std::bind(&LogicSystem::HeartBeatHandler, this,
	std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
}
...
void LogicSystem::DealChatTextMsg(std::shared_ptr<CSession> session, const short& msg_id, const std::string& msg_data){
    ...
    //查询redis 查找touid对应的server ip，先看对面在不在线。
    auto to_str = std::to_string(touid);
    auto to_ip_key = USERIPPREFIX + to_str;
    std::string to_ip_value = "";
    bool b_ip = RedisMgr::GetInstance()->Get(to_ip_key, to_ip_value);
